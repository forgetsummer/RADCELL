...
//         mySim.SetCellWorld(0.1,0.1,0.1);//create cell world, dimension in unit of mm, this line is for testing single cell simulation
    ...
    mySim.RADCellSimulationInitialize(argc, argv);// inmySim.SetCellSimulationParameter(1,"Nucleus");itialize the radiation transport module
    ...
    stringstream ss_energy;mySim.SetCellSimulationParameter(1,"Nucleus");
    stringstream ss_out;
