...
int main(int argc,char** argv)
{
    ...
    int cellNum = 10000; //unit in number
...
//             myCellState.CellPhaseInitializationRandom(i,1);
    ...
    //****************************************************************************************
        ...
        {  
            ...
            myCellState.CellStateUpdate(mitr_cell->first,cellType,n*0.01*40,0,0,1);
//             myCellState.CellStateUpdate(mitr_cell->first,cellType,n*0.01*40,0,deltaT_cellStateUpdate,1);
        }
...
//             cout<<"Cell: "<<mitr_cell->first<<" State: "<<stateMap[mitr_cell->first]<<" Age: "<<ageMap[mitr_cell->first]<<" Duration: "<<durationMap[mitr_cell->first]<<endl;
        ...
        file1<<n<<","<<S1_num<<","<<S21_num<<","<<S22_num<<","<<S3_num<<","<<S1_num+S21_num+S22_num+S3_num<< endl;
