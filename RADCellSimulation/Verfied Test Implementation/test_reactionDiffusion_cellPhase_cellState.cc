...
int main(int argc,char** argv)
{
    ...
    double deltaT_diffusionUpdate=60;// unicout<<"get here"<<endl;t in second
...
//         layout.RectangularSlab(xDim,yDim,zDim,cellNum); // this line is for multiple cell simulation
...
//*******************************************************************************************************************
    ...
    for (int n=0;n<=doseCaseNum;n++)// simulation for different prescribed dose
    {
        ...
        for (int i =1; i<=2;i++) // running five different experiment, set up the particle number in here
        {
            ...
            particleNumberVec.push_back(i*1); // initialize the vector 
        }
        //************************************************************************************************************
        //************************************************************************************************************
        ...
        for (int i=1;i<=50;i++)
        {
            particleEnergyVec.push_back(i*1); // the first 50 energy groups, from 1MeV to 50MeV, delt_E=1MeV
        }
        
        // this is for electron simulation
        //*************************************************************************************************************

        
//             for (int i=1;i<=10;i++)
//             {
//                 particleEnergyVec.push_back(i*0.1); // the first 10 energy groups, from 0.1MeV to 1MeV, delt_E=0.1MeV
//             }
//             cout<<"get here"<<endl;
//             for (int i=2;i<=20;i++)
//             {
//                 particleEnergyVec.push_back(i*1); // the second energy groups, from 2MeV to 20MeV, delt_E=1MeV
//             } 
//             for (int i=2;i<=100;i++)
//             {
//                 particleEnergyVec.push_back(i*10);
//             }
            
        // this is for proton simulation
        //***************************************************************************************************************
        //***************************************************************************************************************
        
        for (int i=0;i<1;i++) // loop energy groups
        {
...
//                     double concentrationInMass = 1E+4*massOfBystanderSignal/volume;
                    ...
                    {
                        ReadRadiationTransportInfo radiationTransResulut;
