...
//         mySim.SetCellSimulationParameter(1,"Nucleus");
        ...
        for (int i =1; i<=2;i++) // running five different experiment, set up the particle number in here
        {
            ...
            particleNumberVec.push_back(i*10000); // initialize the vector 
        }
        //////////////////////////////////////////////////////////////////////////////////
        ...
        std::vector<double> particleEnergyVec; // the vector storing the particle energy for each run
        {
            ...
            for (int i=1;i<=50;i++)
            {
                particleEnergyVec.push_back(i*2); // the first 50 energy groups, from 0.02MeV to 1MeV, delt_E=0.02MeV
            }
            
            for (int i=1;i<=2;i++)
            {
                particleEnergyVec.push_back(i*10); // the second 100 energy groups, from 10MeV to 1000MeV, delt_E=10MeV
            }
...
//             for (int i=2;i<=20;i++)
//             {
//                 particleEnergyVec.push_back(i*1); // the second energy groups, from 1MeV to 20MeV, delt_E=1MeV
//             } 
//             for (int i=2;i<=100;i++)
//             {
