...
//*******************************************************************************
    double xDim=2;//unit in mm
    double yDim=2;//unit in mm
    double zDim=2;//unit in mm
...
//     int particleNumber = 500;
    ...
    testSource.RadiationPlaneSourceSetUp(testRadiationName,particleNumber,particleEnergy,0,0,1.1,xDim,yDim);
