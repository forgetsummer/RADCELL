...
//     double mu=200; // unit in #
    ...
    double f1 = 0.62;
    double f2 = 0.38;
    double lambda1=1.90; // unit in 1/hour
    double lambda2=0.07; // unit in 1/hour
...
//     ********************** Single Cell Irradiation for calculate the absolute dose and DNA damage of cells
    ...
    singleCellIrradiationSource.RadiationPointSourceSetUp("Mono_Proton",10000,8,0,0,0.04);
